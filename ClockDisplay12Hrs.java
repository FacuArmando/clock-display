...
/**
 * The ClockDisplay12Hrs class implements a digital clock display for a
 ...
 * @version 2016.02.29
 */
public class ClockDisplay12Hrs
{
    ...
    /**
     * Constructor for ClockDisplay12Hrs objects. This constructor 
     * creates a new clock set at 00:00.
     */
    public ClockDisplay12Hrs()
    {
     ...
     * parameters.
     */
    public ClockDisplay12Hrs(int hour, int minute)
    {
        hours = new NumberDisplay(24);
        minutes = new NumberDisplay(60);
        setTime(hour, minute);
    ...
    public String getTime()
    {
        if(hours.getValue()==00){
            ...
            if(hours.getValue()>=13 && hours.getValue()<24){
